<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <div id="header-section">
        <h1 class="logo"><a href=""><img src="/static/images/logo_wht.png"></a></h1>
        <div class="gnb">
            <ul class="g-menu1">
            ...
            <ul class="g-menu2">
                <li><a href="/membership/vipzone">멤버쉽</a></li>
                <li><a href="">고객센터</a></li>
        ...
        <div id="nav">
            <ul class="main-nav">
                <li class="main-nav-detail">
                    <a href="" class="main-nav-title">예매</a>
                    <div class="nav-nav1">
                        <ul>
                            <li><a href="">예매하기</a></li>
                ...
                <li class="main-nav-detail">
                    <a href="#" class="main-nav-title">영화</a>
                    <div class="nav-nav1">
                        <ul>
                            <li><a href="">홈</a></li>
                ...
                <li class="main-nav-detail">
                    <a href="" class="main-nav-title">영화관</a>
                    <div class="nav-nav1">
                        <ul>
                            <li><a href="">스페셜관</a>
                                <div class="nav-nav2">
                ...
                <li class="main-nav-detail">
                    <a href="/event" class="main-nav-title">이벤트</a>
                    <div class="nav-nav1">
                        <ul>
                            <li><a href="/event">홈</a></li>
                            <li><a href="/event/home">영화</a></li>
                ...
                <li class="main-nav-detail">
                    <a href="/store" class="main-nav-title">스토어</a>
                    <div class="nav-nav1">
                        <ul>
                            <li><a href="">베스트</a></li>
                            <li><a href="">관람권</a></li>
