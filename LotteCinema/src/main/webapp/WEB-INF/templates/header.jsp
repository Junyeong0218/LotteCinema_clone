                ...
                <div class="whole-menu-wrapper">
                    <div class="top-wrapper">
                        <div class="menu-wrapper">
                            <table>
                                <tr>
                                    <th class="menu-title"><span>예매</span></th>
                                    <th class="menu-title"><span>영화</span></th>
                                    <th class="menu-title"><span>영화관</span></th>
                                    <th class="menu-title"><span>스페셜관</span></th>
                                    <th class="menu-title"><span>스토어</span></th>
                                    <th class="menu-title"><span>멤버십</span></th>
                                </tr>
                                <tr>
                                    <td class="menu-items">
                                        <ul>
                                ...
                                <tr>
                                    <th class="menu-title"><span>마이</span></th>
                                    <th class="menu-title"><span>고객센터</span></th>
                                    <th class="menu-title"><span>회원</span></th>
                                    <th class="menu-title"><span>이벤트</span></th>
                                    <th class="menu-title"><span>할인안내</span></th>
                                    <th class="menu-title"><span>회사소개</span></th>
                                </tr>
                                <tr>
                                    <td class="menu-items">
                                        <ul>
                                    ...
                                    <td class="menu-items">
                                        <ul>
                                            <<<<<<< HEAD:LotteCinema/src/main/webapp/WEB-INF/templates/header.jsp <li><a
                                                ...
                                                >>>>>>>
                                                origin/gyeongun:LotteCinema/src/main/webapp/WEB-INF/templetes/header.jsp
                                                <li><a href="#">회원약관</a></li>
                        ...
                        <div class="user-wrapper">
                            <div class="user-info">
                                <<<<<<< HEAD:LotteCinema/src/main/webapp/WEB-INF/templates/header.jsp <c:if
                                    ...
                                    <c:if test="${sessionScope.user != null}">
                                        ...
                                        <div class="my-cinema">
                                            <div class="my-cinema-title">
                                                <span>MY 영화관</span>
                                                <button type="button" class="to-my-cinema"><img
                                                        src="/static/images/whole_menu_logined_set_my_cinema.png"
                                                        alt=""></button>
                                            </div>
                                            <div class="my-cinema-rank">
                                                <a href="#" class="set-my-cinema-rank">
                                                    <img class="plus" src="/static/images/whole_menu_logined_plus.png"
                                                        alt="">
                            ...
                            <div class="modal-small-banner">
                                <a href="#">
                                    <img src="/static/images/modal_small_banner.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="region-list hidden">
                                        <ul>
                                            ...
                                            <li><a href="#">진접</a></li>
                                            <li><a href="#">파주운정</a></li>
                                            <li><a href="#">판교(창조경제밸리)</a>
                                            </li>
                                            <li><a href="#">평촌(범계역)</a></li>
                                            <li><a href="#">평택비전(뉴코아)</a>
                                            </li>
                                            <li><a href="#">하남미사</a></li>
                                            <li><a href="#">향남</a></li>
                                        </ul>
                                ...
                                <li>
                                    ...
                                    <div class="region-list hidden">
                                        <ul>
                                            ...
                                            <li><a href="#">광복</a></li>
                                            <li><a href="#">김해부원</a></li>
                                            <li><a href="#">김해아울렛(장유)</a>
                                            </li>
                                            <li><a href="#">대영</a></li>
                                            <li><a href="#">동래</a></li>
                                            <li><a href="#">동부산아울렛</a></li>
                                            <li><a href="#">드라이브 오시리아</a>
                                            </li>
                                            ...
                                            <li><a href="#">울산성남</a></li>
                                            <li><a href="#">진주혁신(롯데몰)</a>
                                            </li>
                                            <li><a href="#">진해</a></li>
                                            <li><a href="#">창원</a></li>
                                            <li><a href="#">통영</a></li>
                                            <li><a href="#">프리미엄경남대</a></li>
                                            <li><a href="#">프리미엄진주(중안)</a>
                                            </li>
                                            <li><a href="#">프리미엄해운대(장산역)</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
