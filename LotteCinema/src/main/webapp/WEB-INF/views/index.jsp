			...
			<div id="contents">
				<div id="sub-section">
					...
					<div class="visual-ad">
						<ul class="slide-img">
							<li><div>
									<img src="/static/images/Air_1920774.jpg" alt="">
								</div></li>
							<li><div>
									<img src="/static/images/Ani_1920774.jpg" alt="">
								</div></li>
							<li><div>
									<img src="/static/images/Super_1920774.jpg" alt="">
								</div></li>
							<li><div>
									<img src="/static/images/Ruy_1920774.jpg" alt="">
								</div></li>
							<li><div>
									<img src="/static/images/Lost_1920774.jpg" alt="">
								</div></li>
						</ul>
					...
					<div id="main-banners">
						<div class="banner-wrapper">
							<ul class="banner-list">
								...
								<li class="poster-img-box"><img
									src="/static/images/main_small_banner_01.jpg" alt=""> <span>1</span>
									<div class="banner-desc">
										<span class="banner-title">수퍼 소닉2</span>
										<div class="scores">
											<span>예매율 37.9%</span> <span class="star">8.3</span>
											<button></button>
										</div>
									</div></li>

								<li class="poster-img-box"><img
									src="/static/images/main_small_banner_02.jpg" alt=""> <span>2</span>
									<div class="banner-desc">
										<span class="banner-title">신비한 동물들과 덤블도어의 비밀</span>
										<div class="scores">
											<span>예매율 16.6%</span> <span class="d-day">D-4</span>
											<button></button>
										</div>
									</div></li>
								<li class="poster-img-box"><img
									src="/static/images/main_small_banner_03.jpg" alt=""> <span>3</span>
									<div class="banner-desc">
										<span class="banner-title">앰뷸런스</span>
										<div class="scores">
											<span>예매율 8.6%</span> <span class="star">8.1</span>
											<button></button>
										</div>
									</div></li>
								<li class="poster-img-box"><img
									src="/static/images/main_small_banner_04.jpg" alt=""> <span>4</span>
									<div class="banner-desc">
										<span class="banner-title">모비우스</span>
										<div class="scores">
											<span>예매율 8.6%</span> <span class="star">7.9</span>
											<button></button>
										</div>
									</div></li>
								<li class="poster-img-box"><img
									src="/static/images/main_small_banner_05.jpg" alt=""> <span>5</span>
									<div class="banner-desc">
										<span class="banner-title">앵커</span>
										<div class="scores">
											<span>예매율 5.3%</span> <span class="d-day">D-11</span>
											<button></button>
										</div>
									</div>
							</ul>
					...
					<div id="content">
						...
						<div class="main-cont-premiere">
							<div class="premiere-title">
								<span>시사회/무대인사</span> <a href="">더보기 ></a>
							</div>
