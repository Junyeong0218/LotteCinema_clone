                                            ...
                                            <div class="main-contents">
                                                <div class="consent">
                                                    ...
                                                    <div class="input-name">
                                                        <input type="text" name="name" placeholder="한글 또는 영문으로 입력해주세요."
                                                            maxlength="30">
                                                    </div>
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <div class="input-date-ft">
                                                        <input type="number" name="birthday" placeholder="생년월일을 입력해주세요."
                                                            min="0" max="999999">
                                                    </div>
                                                    ...
                                                    <div class="terms">
                                                        <span>-휴대폰 본인확인 시 타인 명의를 도용할 경우, "정보통신망법 제 49조"에 의거하여 5년 이하의 징역
                                                            또는 5천만원 이하의 벌금에 처할 수
                                                            있습니다.</span>
                                                    </div>
                                                </div>
                                                <div class="personal-data">
                                                ...
                                                <div class="terms">
                                                    <span>-휴대폰 본인확인 시 타인 명의를 도용할 경우, "정보통신망법 제 49조"에 의거하여 5년 이하의 징역 또는
                                                        5천만원 이하의 벌금에 처할 수
                                                        있습니다.</span>
                                                </div>
                                            </div>
