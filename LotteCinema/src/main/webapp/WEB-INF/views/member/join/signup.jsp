                ...
                <main>
                    <div id="contents">
                        ...
                        <div class="agree-marketing">
                            ...
                            <div class="check-all">
                                <input type="checkbox" id="checkAll" name="check-all" class="radiobox"
                            ...
                            <div class="radio-button-wrapper">
                                ...
                                <div class="radio-buttons">
                                    <input type="checkbox" id="emailAccept" name="accept" class="radiobox"
                                        onclick="checkSelectAll(this)">
                                    <label for="emailAccept"><img src="/static/images/radio_button_img.png"
                                            alt=""></label>
                                    <span>E-mail</span>
                                    <input type="checkbox" id="smsAccept" name="accept" class="radiobox"
                                        onclick="checkSelectAll(this)">
