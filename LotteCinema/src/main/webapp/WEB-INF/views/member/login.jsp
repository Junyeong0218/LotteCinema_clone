									...
									<div class="login-area">
										<form action="/member/login" class="login-input-box">
											<input type="text" class="username" name="username"
												placeholder="아이디 또는 이메일을 입력해 주세요."> <input type="password"
												class="password" name="password" placeholder="비밀번호를 입력해 주세요.">
										</form>
										<button class="login">로그인</button>
									</div>
									<div class="login-assist">
										<div class="login-check">
											<input type="checkbox" id="checkSavedID"> <label for="checkSavedID">아이디
												저장</label>
										</div>
									...
									<div class="not-member-login">
										<div class="n-login-items">
											<div class="n-login-input">
												...
												<div class="label-box">
													<label for="password2">예매 비밀번호
														<input type="password" placeholder="예매 비밀번호 (4자리)를 입력해 주세요.">
													</label>
												</div>
												<div class="label-box">
													<label for="password3">예매 비밀번호 확인
														<input type="password" placeholder="예매 비밀번호 (4자리)를 재입력해 주세요.">
													</label>
												</div>
											</div>
								...
								<div class="n-login-input-box">
									<div class="not-member-reservation">
										<div class="n-login-items">
											<div class="n-reservation-input">
												...
												<div class="label-box">
													<label for="password2">예매 비밀번호<input type="text"
									...
									<div class="txtarea-box">
										...
										<div class="agreement-check-box">
											...
											<label for="privacyOk1">동의</label>
											<input type="radio" name="agree-check2" id="privacyOk2">
											<label for="privacyOk2">동의하지 않음</label>
										</div>
									</div>
									<div class="signup-signin-button">
								...
								<div class="login-items-social">
									<div class="a-box-social">
										<a href="#" class="btn-naver-social" title="네이버 계정으로 새창열기">네이버
											계정으로 로그인</a> <a href="#" class="btn-cacao-social" title="카카오 계정으로 새창열기">카카오
											계정으로 로그인</a>
