                            ...
                            <div class="not-member">
                                ...
                                <div class="not-member-login current">
                                    <div class="n-login-input-box">
                                        ...
                                        <div class="n-login-info">
                                            <p>비회원 로그인 시 예매 및 예매확인/취소 메뉴만 이용 가능하며 관람권, 할인권을 포함한 기타 결제, 할인수단은 정회원 로그인 시
                                                사용 가능합니다.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="txtarea-box">
                                            <div class="txtarea">
                                                ...
                                                <span class="color-red">
                                                    <br>개인정보의 보유 및 이용기간
                                                    <br>개인정보는 영화 예매 완료 후 동의일로부터 70일까지 위 이용 목적으로 이용 및 보유 합니다. (단, 생년월일은
                                                    이용자 식별 목적으로 이용되며 별도 보관되지 않습니다.)
                                                    <br>다만, 상법 등 관련법령의 규정에 의하여 거래 관련 관리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할
                                                    필요가 있을 경우 아래와 같이 보유합니다.
                                                    <br>대금결제 및 재화 등의 공급에 관한 기록 : 5년
                                                </span>
                                                <br>
                                                <br>※ 비회원 예매서비스 제공을 위한 최소한의 개인정보이며 거부할 수 있습니다. 다만, 수집에 동의하지 않을 경우 서비스
                                                이용이 제한됩니다.
                                            </div>
                                        </div>
                                ...
                                <div class="not-member-reservation">
                                    ...
                                    <div class="txtarea-box">
                                        ...
                                        <div class="agreement-check-box">
                                            <input type="radio" name="agree-check" id="agreeForReservation"
                                                checked="checked">
